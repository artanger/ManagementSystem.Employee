...
namespace ManagementSystem.Employee.Controllers
{
    public class ProductDetailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Color,Description,ProductID")] ProductDetails productDetails)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Color,Description,ProductID")] ProductDetails productDetails)
        {
            if (ModelState.IsValid)
            {
